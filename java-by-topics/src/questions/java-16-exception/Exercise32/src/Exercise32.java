 ...
 * Checking End. Please contact the account holder if any of them balance < 1000
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < 5; i++) {
                ...
                System.out.println(accNo[i] + "\t" + holder[i] + "\t" + balance[i]);
                if (balance[i] < 1000)
                    throw new CustomException(holder[i] + "'s balance is less than 1000.");
                // display own exception if balance < 1000
            }
            System.out.println("This is the end of the program, but it would not come here.");
        } catch (Exception e) {
            e.printStackTrace();
            System.out.println("Checking End. Please contact the account holder if any of them balance < 1000");
        } finally {
